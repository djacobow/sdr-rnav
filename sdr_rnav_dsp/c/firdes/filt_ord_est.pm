...
# routines to calculate the remez weights arguments required to 
# realize the desired amplitues by band, plus calculate how many
# taps are likely required. Cribbed from GNU Radio and translated
# from Pythion to Perl
# -- 10/18/2013 Dave Jacobowitz
